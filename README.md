...
本文档描述了 Q-Upload-Server 中所有重要接口和工具方法的参数说明，包括小文件上传、大文件分片上传、文件检查、合并等核心功能。
...
### 3. getMimeType - 获取文件 MIME 类型

**功能描述：** 根据文件扩展名获取 MIME 类型

**参数：**

- `fileName` (string): 文件名

**MIME 类型映射：** [index.js:215-265]
